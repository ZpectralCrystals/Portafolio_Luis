                ...
                <div className="border-b border-[var(--line)] p-6 sm:p-8 lg:border-b-0 lg:border-r">
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="grid h-12 w-12 place-items-center rounded-2xl bg-[var(--contrast)] text-[var(--contrast-foreground)] shadow-[0_12px_30px_rgba(15,23,42,0.14)]">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <ul className="mt-7 grid gap-3 xl:grid-cols-2">
                    {experience.bullets.map((bullet) => (
                      <li
                        key={bullet}
                        className="flex gap-3 rounded-2xl border border-[var(--line)] bg-[var(--surface)] p-4 text-sm leading-7 text-[var(--ink-muted)]"
                      >
